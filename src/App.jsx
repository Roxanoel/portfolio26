...
import { MentalHealthCheckInForTeenagers } from "./pages/projects/MentalHealthCheckInForTeenagers";
...
import { OpteoDesignSystemOverhaul } from "./pages/projects/OpteoDesignSystemOverhaul";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/work/mental-health-check-in-for-teenagers" element={<MentalHealthCheckInForTeenagers />} />
